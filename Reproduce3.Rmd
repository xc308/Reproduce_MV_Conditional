...
# 2071 mesh node points, need to calculate distance btw pairs of locations, 1 node with the rest of 2070 + it self, then runnung over all 2071 nodes, so h is of size 2071*2071
