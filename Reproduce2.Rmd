...
#save(fit.Model1, file = "./Results/fit.Model1.rda")
#save(fit.Model2, file = "./Results/fit.Model2.rda")
#save(fit.Model3, file = "./Results/fit.Model3.rda")
```
...
X4 <- construct_mat(theta = append_theta(theta = fit.Model4$par, 
                                         model_num = 4), 
