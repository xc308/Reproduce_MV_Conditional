...
```{r}
# bisquare function
bisq_2D <- function(hvec, delta = c(0, 0), r = 1, A = 1) {
...
bisq_B <- function(hvec, delta = c(0, 0), r = 1, A = 1, area = 1, n1 = 10L, n2 = 10L) {
  BA <- bisq_2D(hvec, delta, r, A) * area
